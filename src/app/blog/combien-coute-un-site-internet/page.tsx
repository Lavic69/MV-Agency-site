...
const TITLE = "Combien coûte un site internet en 2026 ?";
const DESCRIPTION =
...
const COVER = "/og/combien-coute-un-site-internet.png";
  ...
  return (
    <main className={styles.articleWrapper}>
      ...
      <ArticleHeader
        ...
        updatedAt={UPDATED_AT}
        coverImage={COVER}
        coverAlt="Illustration d'un guide des prix d'un site internet en 2026"
      />
      ...
      <article>
        ...
        <h2>Comment obtenir un devis fiable pour votre projet ?</h2>
        <p>
          La méthode qui fonctionne, peu importe l'agence : préparer un brief court mais
          précis avant de demander un chiffrage. Un bon brief contient l'objectif
          principal du site, le public cible, les fonctionnalités attendues, les
          inspirations visuelles, le contenu déjà disponible et la deadline souhaitée.
          Avec ces cinq éléments, n'importe quelle agence sérieuse peut produire un
          devis détaillé en moins de 48 h.
        </p>
        <p>
      ...
      <RelatedArticles currentSlug={SLUG} pillar="creation-site-web" />
